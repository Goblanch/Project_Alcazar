...
public class VectorLabelsAttributeDrawer : PropertyDrawer
{
    ...
    {
        int factor = EditorGUIUtility.currentViewWidth < twoLinesThreshold ? 2 : 1;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.propertyType == SerializedPropertyType.Vector2Int)
        {
            ...
            array = DrawFields(position, array, label.text, EditorGUI.IntField, vectorLabels);
        ...
        else if (property.propertyType == SerializedPropertyType.Vector2)
        {
            ...
            array = DrawFields(position, array, label.text, EditorGUI.FloatField, vectorLabels);
    ...
    private T[] DrawFields<T>(Rect rect, T[] vector, string mainLabel, System.Func<Rect, GUIContent, T, T> fieldDrawer, VectorLabelsAttribute vectorLabels)
    {
        ...
        bool twoLinesLayout = EditorGUIUtility.currentViewWidth < twoLinesThreshold;
